...
eset1.f = genefilter::varFilter(eset1, filterByQuantile = T, var.cutoff = 0.99)
...
eset2.f = genefilter::varFilter(eset2, filterByQuantile = T, var.cutoff = 0.99)
...
eset3.f = genefilter::varFilter(eset3, filterByQuantile = T, var.cutoff = 0.99)
